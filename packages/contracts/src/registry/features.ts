...
export const FEATURES: FeatureEntry[] = [
  ...
  },
  {
    ...
    description:
      'Product-shipment fulfilment requests with line items, evolved from single-shipment gifting (W3-5) into a full workflow: one-or-many shipments per campaign participation, optionally linked to a deliverable, cross-campaign /logistics workspace, status sync (activity + notifications). Recipient PII is redacted server-side for VIEWER role.',
    module: 'Logistics',
    classification: 'SHARED',
    apiStatus: 'READY',
    webStatus: 'READY',
