...
**Coverage:** 45 features · API ready 44 · Web ready 45 · Mobile ready 41 · Admin-desktop-only 4 · **Mobile readiness 100%** (of SHARED features).
...
### My work and approvals

- `GET /api/v1/me/work`
- `GET /api/v1/me/work/counts`
