...
المتابعين، **بالإضافة إلى عدد الإعجابات والتعليقات لكل منشور** من منشوراتها
**الحديثة** (عبر طرف `media`).
...
- **لا يعطي المشاهدات إطلاقاً** — `business_discovery` لا تكشفها، فالمشاهدات
  مقياس insights لا يُقرأ إلا على حساب فوّض تطبيقك. المحوّل يُرجِع `views: null`
  ولا يستبدلها برقم شبيه؛ المشاهدات تبقى يدوية.
- **لا يعطي شيئاً للحسابات الشخصية** — غير قابلة للاكتشاف، فتبقى يدوية بالكامل.
- المشاهدات الكاملة وتيك توك تحتاج تفويض المؤثر نفسه (Creator-OAuth، القسم 5).
